      ...
      <Layout.Contents className='policy-container'>
        ...
        <section>
          ...
          <ol>
            ...
            <li>{`"사이트"는 불특정다수 회원에 대한 통지의 경우 1주일 이상 "사이트" 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.`}</li>
          </ol>
        </section>
        <section>
        ...
        <section>
          ...
          <ol>
            ...
            <li>{`"이용자"가 해당 서비스의 다음 달 이용신청을 취소하고자 하는 경우에는 앱 내 구독관리 페이지에서 예약해지를 진행해야 합니다. 예약해지를 신청하면 해지가 진행되는 다음 결제일 전까지 건강해짐 서비스를 계속 이용할 수 있습니다. 낮은 레벨의 멤버십으로 변경하는 경우 역시 마찬가지로 앱 내 구독관리 페이지에서 변경 가능하며, 다음 결제일 전까지 기존 멤버십을 이용하다 결제일을 기준으로 변경됩니다.`}</li>
            <li>{`"이용자"는 "사이트"가 제공하는 멤버십 서비스를 환불 및 변경할 수 있습니다. 단, 멤버십 결제가 이루어진 지 7일이 지났거나 7일 이내더라도 "이용자"가 멤버십 서비스를 이용한 내역이 있다면 환불이 불가능합니다. 회사는 해당 내용에 대해 결제 단계에서 충분히 고지하며, "이용자"는 첫 달 결제 때 해당 내용을 승인해야 유료서비스를 이용할 수 있습니다.`}</li>
            <li>
              <p>{`다음 각 호의 경우에 "이용자"는 환불을 요청할 수 없습니다.`}</p>
              <ul>
                <li>{`결제 후 멤버십 서비스에서 제공하는 기능을 이용한 경우`}</li>
                <li>{`가장 최근의 멤버십 결제가 이루어진 지, 만 7일이 지난 경우`}</li>
        ...
        <section>
          ...
          <ol>
            ...
            <li>{`"사이트"는 회원가입 시 구매계약이행에 필요한 정보를 미리 수집하지 않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에 본인확인이 필요한 경우로서 최소한의 특정 개인정보를 수집하는 경우에는 그러하지 아니합니다.`}</li>
            ...
            <li>{`"사이트" 또는 그로부터 개인정보를 제공받은 제 3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다. "사이트"는 개인정보의 수집 · 이용 · 제공에 관한 동의 란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집 · 이용 · 제공에 관한 이용자의 동의 거절 시 제한되는 서비스를 구체적으로 명시하고, 필수수집항목이 아닌 개인정보의 수집 · 이용 · 제공에 관한 이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나 거절하지 않습니다.`}</li>
        ...
        <section>
          ...
          <ol>
            ...
            <li>{`"사이트"가 상품이나 용역에 대하여 「표시 · 광고의 공정화에 관한 법률」 제 3조 소정의 부당한 표시 · 광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.`}</li>
            <li>{`"사이트"는 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.`}</li>
            <li>{`"사이트"는 서비스 제공과 관련하여 알게 된 회원의 정보를 본인의 승낙 없이 제 3자에게 누설 및 배포하지 않습니다. 단, 관계법령에 따른 수사상의 목적으로 관계 기관으로부터 요구를 받았거나 방송통신심의위원회로부터 요청 등이 있는 등 법률의 규정에 따른 적법한 절차에 의한 경우에는 그렇지 않습니다.`}</li>
          </ol>
        </section>
        <section>
          ...
          <ol>
            ...
            <li>{`회원은 자신의 ID 및 비밀번호를 제 3자에게 이용하게 해서는 안 됩니다.`}</li>
        ...
        <section>
          ...
          <ol>
            ...
            <li>{`이용자는 "사이트"를 이용함으로써 얻은 정보 중 "사이트"에게 지적재산권에 귀속된 정보를 "사이트"의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제 3자에게 이용하게 하여서는 안 됩니다.`}</li>
        ...
        <section>
          ...
          <ol>
            <li>{`"사이트"와 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다`}</li>
